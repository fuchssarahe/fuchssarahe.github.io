const resumeConstants = {
  ...
  projects: [
    ...
    },
    {
      ...
      bullets: ['Synchronous and asynchronous lanuage details handled differently to provide identical user experience between implementations', 'Tree data structure used to quickly determine which chords to display to the user']
    }
  ],
